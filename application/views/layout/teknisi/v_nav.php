...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('teknisi') ?>">
        <div class="sidebar-brand-icon">
            <img src="<?= base_url() ?>template/img/logo/logo2.png">
        </div>
        <div class="sidebar-brand-text mx-3">Ruangteknisi</div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('teknisi/boking_masuk') ?>">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="ml-2 d-none d-lg-inline text-white small">Teknisi</span>
                    </a>
